...
if __name__ == '__main__':
    et = ExtTool.from_filename(r"F:\RBWO\TEST\april\降场强\low.m2d")
    ...
    range_JDA_title = ' FIELD JZ @BEAM_LINE$ #8.1'
    ax2 = axs[1].twinx()
